  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <nav>
        ...
        <!-- Navbar Right Menu -->
        <div class="nav-tabs-custom" style="background-color: #d2d6de;">
          <ul class="nav nav-tabs">
            ...
            <li class="pull-right" style="font-size: 18px;"><a href="#"><i class="fa fa-user"></i>  Account</a></li>
            <li class="pull-right" style="font-size: 18px;"><a href="#"><i class="fa fa-bitcoin"></i>  12.988</a></li>
          </ul>
            ...
            <aside class="main-sidebar">
              ...
              <section class="sidebar">
                ...
                <div class="sidebar" style="margin-right: 8px; margin-left: 8px;">
                  <button type="button" class="btn btn-block btn-success">TOKEN</button>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                  ...
                  <?php
                    for ($i=1; $i <20 ; $i++) { 
                      echo '
                      <li class="treeview" style="font-size: 15px; margin-top: 10px; margin-bottom: 10px;">
                        <a href="#">
                        <div class="pull-left">  
                ...
                <div class="box">
                  <div class="box-body">
                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <h4 class="text-center">Open Orders</h4>
                    <!-- Open Orders -->
                    ...
                    <h4 class="text-center">My Order History</h4>
                    <!-- Open Orders -->
                    <table class="table table-hover" id="oh" width="100%" cellspacing="0">
                      <thead>
                         <tr style="background-color: #f4f4f5;">
                          <th>CLOSED DATE</th>
                          <th>OPEN DATE</th>
