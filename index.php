    ...
    <header class="main-header">
      ...
      <nav>
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            <li class="pull-right" style="font-size: 16px;"><a href="#">SUN / NIGHT</a></li>
            <li class="pull-right" style="font-size: 16px;"><a href="#">GT</a></li>
      ...
      <!-- Left side column. contains the logo and sidebar -->
        ...
        <div class="tab-content" style="margin-top: -25px;">
                 ...
                 <div class="box box-solid">
                  ...
                  <div class="box-body">
                    <embed style="height: 300px;">
                      <a class="twitter-timeline" href="https://twitter.com/StellarLumens?ref_src=twsrc%5Etfw">Tweets by StellarLumens</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </embed>
                  </div>
                  <!-- /.box-body -->
                </div>
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#buyasset" data-toggle="tab">BUY</a></li>
              <li><a href="#sellasset" data-toggle="tab">SELL</a></li>
              <li><a href="#stoplmt" data-toggle="tab">STOP LIMIT</a></li>
              
              <li class="pull-right"><a href="#" class="text-muted"><i class="fa fa-gear"></i></a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="buyasset">
                
                <div class="text-right">
                  <h5 style="margin-top: 10px;"><b>0.00000000 BTC</b> : Lowest Ask</h5>
                </div>
              ...
              <!-- /.tab-pane -->
              <div class="tab-pane" id="sellasset">
                <div class="text-right">
                  <h5 style="margin-top: 10px;" class="box-title"><b>0.00000000 BTC</b> : Highest Bid</h5>
                </div>
              ...
              <!-- /.tab-pane -->
              <div class="tab-pane" id="stoplmt">
                <div class="text-right">
                  <h5 class="box-title"><b>0.00000000 BTC</b> : You Have</h5>
                  <h5 class="box-title"><b>0.00000000 XLM</b> : You Have</h5>
                </div> 
