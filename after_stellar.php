                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                      <div class="description-block">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <button type="button" class="btn btn-app" style="font-size: 15px;">
                            DEPOSIT
                          </button type="button">
                        </div>
            ...
            <section class="content" style="background-color: #ffffff;">
              <div class="row"> 
                 ...
                 <!-- general form elements -->
                  <div class="box box-success">
                    ...
                    <form role="form" class="form-horizontal">
                      ...
                      <div class="box-footer"  style="background-color: #95c4ac; color: #fff;">
                        <div class="form-group">
                ...
                <div class="col-md-4">  
                  <!-- general form elements -->
                  <div class="box">
                    <div class="box-header" style="background-color: #9a9a9b; color: #fff;">
                    ...
                    <form role="form" class="form-horizontal">
                      ...
                      <div class="box-footer" style="background-color: #d8d8dc; color: #fff;">
                        <div class="form-group">
                          <label class="col-sm-2 control-label">TOTAL</label>
                          <div class="col-sm-10">  
                            <div class="input-group">
                ...
                <div class="col-md-4">  
                  ...
                  <div class="box box-danger">
                    <div class="box-header" style="background-color: #d84431; color: #fff;">
                    ...
                    <form role="form" class="form-horizontal">
                      ...
                      <div class="box-footer" style="background-color: #e57f72; color: #fff;">
                        <div class="form-group">
                          <label class="col-sm-2 control-label">TOTAL</label>
                          <div class="col-sm-10">  
                            <div class="input-group">
